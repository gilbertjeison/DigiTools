    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await Utils.SomeHelpers.SendGridAsync(1, model.Email, model.Nombres + " " + model.Apellidos);
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                string content =  "Por favor resetea tu contraseña haciendo click <a href=\"" + callbackUrl + "\">aquí</a>";
                await Utils.SomeHelpers.SendGridAsync(model.Email, user.Nombres+" "+user.Apellidos,content);
